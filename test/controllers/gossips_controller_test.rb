...
class GossipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gossip" do
    assert_difference('Gossip.count') do
      post gossips_url, params: { gossip: { author: @gossip.author, content: @gossip.content, title: @gossip.title } }
    end
  ...
  test "should update gossip" do
    patch gossip_url(@gossip), params: { gossip: { author: @gossip.author, content: @gossip.content, title: @gossip.title } }
